 ...
 * When adding a new service widget's code, NewsAbility's code no need to change, a derived class inherited from
...
public class NewsAbility extends Ability {
    ...
    private static final HiLogLabel TAG = new HiLogLabel(HiLog.DEBUG, 0x0, NewsAbility.class.getName());
